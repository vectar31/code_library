...
3.For the given string s find the number of occurrences of the strings from the set D.
...
It means that you can't read the whole input at once.
You can read each query only after writing the answer for the last query of the third type.
*/
#include <bits/stdc++.h>
using namespace std;
